<template>
  <div>
    ...
    <div class="search-input-container relative flex items-center">
      <input
        class="search-input block w-full truncate rounded-full border-white border-2 transition-colors py-6 pl-8 pr-20 leading-none text-black placeholder-gray-2 shadow-soft ring-inset focus:border-blue focus:ring-blue disabled:cursor-not-allowed disabled:opacity-50"
        id="search"
        type="text"
        name="search"
        spellcheck="false"
